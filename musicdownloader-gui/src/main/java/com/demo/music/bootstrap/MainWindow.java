...
//                BrowserHelper.initialize(display, (Browser)XWT.findElementByName(shell, "browserId"));
    ...
    public void createAlbumEvent(Event event) throws InterruptedException, ExecutionException, IOException {
        MainWindowController.get(event.widget.getDisplay().getActiveShell()).createAlbum();
    }
