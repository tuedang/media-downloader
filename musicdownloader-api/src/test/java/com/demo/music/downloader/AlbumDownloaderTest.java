...
public class AlbumDownloaderTest {
    ...
    public void downloadAlbumNCT() throws IllegalStateException, IOException {
        ...
        AlbumDownloader albumDownloader = new AlbumDownloader(album, new TargetOutputStreamContext("/Data/NCT/"+ StringHtmlUtils.trimCommonFileName(album.getName())), new SimpleHttpDownloader());
